    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-7 text-slate-300">
          This surface triggers OmniNew to pull your Shopify catalog data for tenant-specific recommendations, grounded policy answers, and storefront assistant context.
        </p>
      </div>
      <SyncForm />
